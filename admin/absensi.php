              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr id=<?= $rec['nis'] ?>>
                    ...
                    <td>
                      <?= $rec['nis'] ?>
                      <input type="hidden" name="nis<?=$rec['nis']?>" value="<?= $rec['nis'] ?>">
                      <input type="hidden" value="<?= cekidabsen($koneksi,$rec['nis']) ?>" name="idabsen<?= $rec['nis'] ?>" />
                      <?php $set = cekidabsen($koneksi,$rec['nis']); ?>
                    </td>
                    <td><?= $rec['nama'] ?> </td>
                    <td>
                      <div class="form-check form-check-inline">
                        <input value="1" <?=cekabsen($koneksi,$rec['nis'],"1")?> class="form-check-input" type="radio" name="ket<?= $rec['nis'] ?>" id="" value="hadir" onclick="warna('#FFFFFF','<?= $rec['nis'] ?>')" checked>
                    ...
                    <td>
                      <div class="form-check form-check-inline">
                        <input value ="2" <?=cekabsen($koneksi,$rec['nis'],"2")?> class="form-check-input" type="radio" name="ket<?= $rec['nis'] ?>" id="" value="sakit" onclick="warna('#8CC0DE','<?= $rec['nis'] ?>')">
                        <label class="form-check-label" for="">
                          Sakit
                        </label>
                      </div>
                    ...
                    <td>
                      <div class="form-check form-check-inline">
                        <input value="3" <?=cekabsen($koneksi,$rec['nis'],"3")?>  class="form-check-input" type="radio" name="ket<?= $rec['nis'] ?>" id="" value="izin" onclick="warna('#FBC687','<?= $rec['nis'] ?>')">
                        <label class="form-check-label" for="">
                          Izin
                        </label>
                      </div>
                    ...
                    <td>
                      <div class="form-check form-check-inline">
                        <input value="4" <?=cekabsen($koneksi,$rec['nis'],"4")?> class="form-check-input" type="radio" name="ket<?= $rec['nis'] ?>" id="" value="alpha" onclick="warna('#EF9F9F','<?= $rec['nis'] ?>')">
                        <label class="form-check-label" for="">
                          Alpa
                        </label>
                      </div>
